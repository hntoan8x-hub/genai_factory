...
# 4. KHỞI ĐỘNG (CMD Production Performance)
# Lệnh CMD này là chuẩn cho K8s Deployment 
CMD ["gunicorn", "api_service.app:app", "--workers", "4", "--bind", "0.0.0.0:8000", "--worker-class", "uvicorn.workers.UvicornWorker"]